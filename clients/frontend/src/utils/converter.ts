...
import { AccountIdentifier, Balance, SubAccount } from './types';
...
export const validateAccountId = (text: string): boolean => text.length === 64 && ALPHANUM_REGEX.test(text);
