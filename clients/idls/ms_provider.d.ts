...
export type Result_1 =
  ...
  | { Err: string };
export type Result_2 = { Ok: Controller } | { Err: SystemErr };
export type Result_3 = { Ok: Array<Controller> } | { Err: SystemErr };
...
export interface _SERVICE {
  ...
  controller_main_create: ActorMethod<[ControllerMainCreateRequest], Result_2>;
