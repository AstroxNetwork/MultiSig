export const idlFactory = ({ IDL }) => {
  ...
  const Result_6 = IDL.Variant({ 'Ok' : SendResponse, 'Err' : EgoBtcError });
  ...
  return IDL.Service({
    ...
    'btc_address_get' : IDL.Func([IDL.Text], [Result_4], ['query']),
    ...
    'btc_balance_path_get' : IDL.Func([IDL.Text], [Result_5], []),
    ...
    'btc_tx_send' : IDL.Func([SendRequest], [Result_6], []),
