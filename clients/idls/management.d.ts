...
export interface _SERVICE {
  canister_status: ActorMethod<[{ canister_id: canister_id }],
    {
  ...
  create_canister: ActorMethod<[{ settings: [] | [canister_settings] }],
  ...
  install_code: ActorMethod<[
    ...
    undefined>;
  provisional_create_canister_with_cycles: ActorMethod<[{ settings: [] | [canister_settings]; amount: [] | [bigint] }],
    { canister_id: canister_id }>;
  provisional_top_up_canister: ActorMethod<[{ canister_id: canister_id; amount: bigint }],
    undefined>;
  ...
  update_settings: ActorMethod<[{ canister_id: Principal; settings: canister_settings }],
    undefined>;
}
