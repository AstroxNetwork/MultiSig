...
export type Result_3 = { 'Ok' : bigint } |
  { 'Err' : string };
export type Result_4 = { 'Ok' : GetAddressResponse } |
  { 'Err' : EgoBtcError };
export type Result_5 = { 'Ok' : UserBalanceResponse } |
  { 'Err' : EgoBtcError };
export type Result_6 = { 'Ok' : SendResponse } |
  { 'Err' : EgoBtcError };
...
export interface _SERVICE {
  ...
  'btc_address_get' : ActorMethod<[string], Result_4>,
  ...
  'btc_balance_path_get' : ActorMethod<[string], Result_5>,
  ...
  'btc_tx_send' : ActorMethod<[SendRequest], Result_6>,
