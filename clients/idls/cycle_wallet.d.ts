...
export interface _SERVICE {
  ...
  get_chart: ActorMethod<[[] | [{ count: [] | [number]; precision: [] | [bigint] }]],
    Array<[bigint, bigint]>>;
  get_controllers: ActorMethod<[], Array<Principal>>;
  get_custodians: ActorMethod<[], Array<Principal>>;
  get_events: ActorMethod<[[] | [{ to: [] | [number]; from: [] | [number] }]],
    Array<Event>>;
  get_events128: ActorMethod<[[] | [{ to: [] | [number]; from: [] | [number] }]],
    Array<Event128>>;
  get_managed_canister_events: ActorMethod<[{ to: [] | [number]; from: [] | [number]; canister: Principal }],
    [] | [Array<ManagedCanisterEvent>]>;
  get_managed_canister_events128: ActorMethod<[{ to: [] | [number]; from: [] | [number]; canister: Principal }],
    [] | [Array<ManagedCanisterEvent128>]>;
  http_request: ActorMethod<[HttpRequest], HttpResponse>;
  list_addresses: ActorMethod<[], Array<AddressEntry>>;
  list_managed_canisters: ActorMethod<[{ to: [] | [number]; from: [] | [number] }],
  ...
  set_short_name: ActorMethod<[Principal, [] | [string]],
    [] | [ManagedCanisterInfo]>;
  ...
  wallet_create_canister128: ActorMethod<[CreateCanisterArgs128],
    WalletResultCreate>;
  wallet_create_wallet: ActorMethod<[CreateCanisterArgs], WalletResultCreate>;
  wallet_create_wallet128: ActorMethod<[CreateCanisterArgs128],
    WalletResultCreate>;
  wallet_receive: ActorMethod<[[] | [ReceiveOptions]], undefined>;
  wallet_send: ActorMethod<[{ canister: Principal; amount: bigint }],
    WalletResult>;
  wallet_send128: ActorMethod<[{ canister: Principal; amount: bigint }],
    WalletResult>;
  wallet_store_wallet_wasm: ActorMethod<[{ wasm_module: Array<number> }],
    undefined>;
}
