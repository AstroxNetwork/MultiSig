...
export type Result = { Ok: Sign } | { Err: SystemErr };
export type Result_1 = { Ok: Action } | { Err: SystemErr };
export type Result_2 = { Ok: Array<Action> } | { Err: SystemErr };
export type Result_3 = { Ok: null } | { Err: SystemErr };
export type Result_4 = { Ok: null } | { Err: string };
export type Result_5 =
  | { Ok: Array<[string, Array<Principal>]> }
  | { Err: string };
export type Result_6 = { Ok: Array<[Principal, string]> } | { Err: SystemErr };
...
export interface _SERVICE {
  ...
  role_user_add: ActorMethod<[string, Principal], Result_3>;
