...
export interface _SERVICE {
  ...
  'app_info_update' : ActorMethod<[string, Version], Result_4>,
  'app_main_create' : ActorMethod<[], Result_5>,
  'app_main_get' : ActorMethod<[], Result_6>,
  'app_version_check' : ActorMethod<[], Result_7>,
  ...
  'role_user_list' : ActorMethod<[], Result_10>,
