...
export type Result = { Ok: AppVersion } | { Err: EgoError };
export type Result_1 = { Ok: boolean } | { Err: EgoError };
export type Result_2 = { Ok: Array<EgoDevApp> } | { Err: EgoError };
export type Result_3 = { Ok: bigint } | { Err: string };
export type Result_4 = { Ok: EgoDevApp } | { Err: EgoError };
export type Result_5 = { Ok: Developer } | { Err: EgoError };
export type Result_6 = { Ok: null } | { Err: string };
export type Result_7 = { Ok: Array<string> } | { Err: string };
export type Result_8 = { Ok: Array<Developer> } | { Err: EgoError };
...
export interface _SERVICE {
  ...
  app_version_upload_wasm: ActorMethod<[AppVersionUploadWasmRequest], Result_1>;
