...
pub use crate::web3::contract::error::deploy::Error;
...
impl<T: Transport> Builder<T> {
        ...
        V: AsRef<str>,
    {
        ...
        self.do_execute(code, params, from, move |tx| {
            crate::web3::api::Personal::new(transport.clone())
...
mod tests {
    ...
    fn deploy_linked_contract() {
        ...
        let lib_address;
        {
            ...
            lib_address =
                futures::executor::block_on(builder.execute(lib_code, (), Address::zero()))
                    .unwrap()
                    .address();
        }
        ...
        transport.assert_no_more_requests();
        {
            ...
            .unwrap();
            let _ = futures::executor::block_on(builder.execute(main_code, (), Address::zero()))
                .unwrap();
        }
